...
export const SPECIES = [
  ...
  {
    id: 'owl', cn: '猫头鹰',
    colors: ['#9c8468', '#8a7358', '#ab9176', '#7c6750'],
    light: '#e3d5bc', dark: '#463628',
    headW: 1.12, headH: 1.0, cheek: 0.35,
    ear: { type: 'tiny', x: 0.82, y: -0.58, size: 0.72, tilt: 0, inner: 'light' },
    eye: { y: -0.18, spread: 0.34, size: 1.35 },
    nose: { type: 'beak', y: 0.24, size: 1.0 },
    mouth: { y: 0.52, philtrum: false },
    muzzle: null, whiskers: false, marks: ['owlDisc'],
    irisChance: 0.9,
  },
  {
    id: 'hedgehog', cn: '刺猬',
    colors: ['#c9a878', '#bd9a6a', '#d6b78a'],
    light: '#f0e4cf', dark: '#5a4636',
    headW: 1.0, headH: 0.98, cheek: 0.5,
    ear: { type: 'tiny', x: 0.88, y: -0.32, size: 0.65, tilt: 0, inner: 'pink' },
    eye: { y: -0.06, spread: 0.34, size: 0.8 },
    nose: { type: 'bulb', y: 0.3, size: 0.85, color: '#3f3229' },
    mouth: { y: 0.54, philtrum: true },
    muzzle: { y: 0.44, w: 0.46, h: 0.3 }, whiskers: false, marks: [], extra: 'spikes',
  },
  {
    id: 'chick', cn: '小鸡',
    colors: ['#e9c878', '#e3bf6c', '#f0d28c'],
    light: '#f7ead0', dark: '#8a6a3a',
    headW: 0.98, headH: 1.0, cheek: 0.7,
    ear: null,
    eye: { y: -0.08, spread: 0.36, size: 0.85 },
    nose: { type: 'beak', y: 0.3, size: 0.95 },
    mouth: { y: 0.56, philtrum: false },
    muzzle: null, whiskers: false, marks: [], extra: 'tuft',
    accPos: { x: 0.6, y: -0.7 },
  },
];
